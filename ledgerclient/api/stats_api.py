...
class StatsApi(object):
    ...
    def read_stats(
        ...
        **kwargs
        ...
        Get ledger stats (aggregate metrics on accounts and transactions) The stats for account   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.read_stats(ledger, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['ledger'] = \
            ledger
        return self.read_stats_endpoint.call_with_http_info(**kwargs)
