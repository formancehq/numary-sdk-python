...
class LedgerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_ledger_info_endpoint = _Endpoint(
            settings={
                'response_type': (LedgerInfoResponse,),
                'auth': [],
                'endpoint_path': '/{ledger}/_info',
    ...
    def get_ledger_info(
        ...
        **kwargs
        ...
        >>> thread = api.get_ledger_info(ledger, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['ledger'] = \
            ledger
        return self.get_ledger_info_endpoint.call_with_http_info(**kwargs)
