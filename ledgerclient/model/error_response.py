...
class ErrorResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["error_code", "errorCode", "errorMessage", "details", "error_message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["error_code", "errorCode", "errorMessage", "details", "error_message", ], str]):
