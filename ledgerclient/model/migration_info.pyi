...
class MigrationInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "date", "state", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "date", "state", ], str]):
