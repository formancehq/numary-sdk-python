...
class ConfigInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config, server, version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, config, server, version, *args, **kwargs):  # noqa: E501
        """ConfigInfo - a model defined in OpenAPI
