...
class LedgerInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class storage(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["driver", "migrations", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["driver", "migrations", ], str]):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "version", "storage", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "version", "storage", ], str]):
        return super().get_item_oapg(name)
