...
class ScriptResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "errorMessage", "details", "transaction", "error_code", "error_message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "errorMessage", "details", "transaction", "error_code", "error_message", ], str]):
