...
class Posting(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, asset, destination, source, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, asset, destination, source, *args, **kwargs):  # noqa: E501
        """Posting - a model defined in OpenAPI
