...
from ledgerclient.exceptions import ApiTypeError, ApiValueError, ApiException
from ledgerclient.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v1.7.0-beta.2/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_metadata_to_account  # this is an instance of the class Endpoint
        api_instance.add_metadata_to_account()  # this invokes api_instance.add_metadata_to_account.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_metadata_to_account.callable or self.callable in this class
