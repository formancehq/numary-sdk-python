...
from ledgerclient.exceptions import ApiTypeError, ApiValueError
from ledgerclient.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/v1.10.15-alpha.1/python'
